...
class TestLCPS:
    ...
    def test_generate_suffix_tree_2(self):
        ...
        assert (
            len(
                edges[0]
                .destination.filtered_edges[1]
                .destination.filtered_edges
            )
            == 2
        )
        assert (
    ...
    def test_suffix_tree(self):
        ...
        assert (
            edges[2].destination.filtered_edges[1].destination.link.link.link
            == tree.root
        )
        assert (
            len(
        ...
        assert (
            edges[3].destination.filtered_edges[1].destination.link.link
            == tree.root
        )
        assert (
            len(
